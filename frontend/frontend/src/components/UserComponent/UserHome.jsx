...
import video from '../../assets/video/4440937-hd_1920_1080_25fps.mp4'
        ...
        <>
            ...
            <div className='flex flex-col md:flex-row border-t-2 border-green-600 bg-slate-900 '>
                ...
                <div className='bg-gradient-to-r from-green-400 to-yellow-300 p-4 md:w-1/2'>
                    ...
                    <h6 className='text-sm md:text-xl font-normal mt-2 md:mt-5'>
                        JOIN WITH US FOR BOOKING TURFS
                    </h6>
                </div>
            </div>
            <div className='flex flex-col md:flex-row gap-2 justify-around p-10'>
                <div className='text-center md:w-1/3 mt-10 md:px-10'>
                    ...
                    <p className='mt-2 text-sm font-light md:text-base'>Are you looking to play after work, organize your Sunday Fives football match? Explore the largest network of sports facilities all over India</p>
                </div>
                <div className='text-center md:w-1/3 mt-10 md:px-10'>
                    <img className='w-14 mx-auto' src={book} alt="" />
                    <h1 className='mt-2 text-2xl'>Book</h1>
                    <p className='mt-2 text-sm font-light md:text-base'>Once you have found the perfect ground, court, or gym, connect with the venue through the Book Now button to make an online booking and secure easier payment.</p>
                </div>
                <div className='text-center md:w-1/3 mt-10 md:px-10'>
                    <img className='w-14 mx-auto' src={play} alt="" />
                    <h1 className='mt-2 text-2xl'>Play</h1>
                    <p className='mt-2 text-sm font-light md:text-base'>You are the hero. You have found a stunning turf or court, booked with ease, and now its time to play. The scene is set for your epic match.</p>
                </div>
            </div>
            <div className='flex flex-col md:flex-row bg-gray-900 py-5'>
                ...
                <div className='text-center md:w-1/2 md:p-10 md:mt-5'>
                    <h1 className='text-green-600 text-3xl md:text-4xl'>MEET WITH PALS</h1>
                    <p className='text-white px-16 mt-5 font-light md:text-lg'>Want to play games ?
                        <br />
                        But dont get an opponent team?
                        <br />
