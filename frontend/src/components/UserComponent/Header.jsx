        ...
        <div className="min-h-full">
            <header style={{ backgroundColor: 'rgb(17, 24, 39)' }}>
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <Link to='/home' className='-m-1.5 p-1.5'>
                            <span className="sr-only text-indigo-600">TURF CONNECT</span>
                ...
                <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                    ...
                    <Dialog className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10" style={{ backgroundColor: 'rgb(17, 24, 39)' }}>
